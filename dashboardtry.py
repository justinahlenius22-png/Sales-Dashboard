...
with col3:
	boxdate = str(datetime.datetime.now().strftime("%d %B %Y"))
...
_, view1, dwn1, view2, dwn2 = st.columns([0.15,0.2,0.2,0.2,0.2])
...
def format_sales(value):
	if value >=0:
		return '{:.2f} Lahk'.format(value/1_000_00)
...
with view5:
	...
	expander=st.expander('View Raw Sales Data')
	expander.write(df)
